...
export default function SettingsPage() {
  ...
  function validateStoreForm(): boolean {
    ...
    if (!storeForm.slug.trim()) {
      errors.slug = 'Store slug is required.';
    } else if (!/^[a-z0-9]+(?:-[a-z0-9]+)*$/.test(storeForm.slug.trim())) {
    ...
    return (
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <Link2 className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary/30" />
            <input
              type="text"
          ...
          <p className="text-xs text-primary/40 mt-1">
            Your store URL: /vendors/{storeForm.slug || 'my-store'}
          </p>
          {fieldErrors.slug && (
        ...
        <div>
          ...
          <div className="relative">
            <FileText className="absolute left-3 top-3 w-4 h-4 text-primary/30" />
            <textarea
  ...
  function renderSocialTab() {
    const platforms: { key: keyof SocialForm; label: string; placeholder: string }[] = [
      {
        key: 'facebook',
        label: 'Facebook',
      ...
      <div className="space-y-6">
        ...
        {platforms.map((platform) => (
          <div key={platform.key}>
            ...
            <div className="relative">
              <AtSign className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary/30" />
              <input
                type="url"
        ...
        <div>
          ...
          <div className="bg-light rounded-lg p-4 border border-light">
            ...
            <p className="text-sm text-green-700 truncate mt-0.5">
              yoursite.com/vendors/{vendor.slug}
            </p>
  ...
  return (
    <div className="min-h-screen bg-light">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm sm:text-base text-primary/60">
                Manage your store details, social profiles, and SEO settings
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tab Navigation */}
        <div className="flex gap-1 mb-6 bg-white rounded-lg border border-light p-1 w-fit">
          {TABS.map((tab) => {
            const Icon = tab.icon;
